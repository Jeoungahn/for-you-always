...
export const BRIDE_FULLNAME = "정지영"
export const BRIDE_FIRSTNAME = "지영"
...
export const GROOM_FULLNAME = "박정안"
export const GROOM_FIRSTNAME = "정안"
export const GROOM_TITLE = "차남"
export const GROOM_FATHER = "박노원"
export const GROOM_MOTHER = "최연순"
